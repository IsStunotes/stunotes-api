...
public class CategoryServiceUnitTest {
    ...
    @Test
    @DisplayName("CP10 - Crear categoría con datos válidos")
    ...
    @Test
    @DisplayName("CP15 - Actualizar categoría con datos válidos")
    ...
    @Test
    @DisplayName("CP16 - Actualizar categoría inexistente")
    ...
    @Test
    @DisplayName("CP17 - Verificar que se establece updatedAt al actualizar")
    ...
    @Test
    @DisplayName("CP20 - Eliminar categoría existente")
    ...
    @Test
    @DisplayName("CP21 - Eliminar categoría inexistente")
    ...
    @Test
    @DisplayName("CP30 - Obtener categoría por ID válido")
    ...
    @Test
    @DisplayName("CP31 - Obtener categoría inexistente")
    ...
    @Test
    @DisplayName("CP32 - Listar todas las categorías")
    ...
    @Test
    @DisplayName("CP33 - Listar categorías sin datos")
    ...
    @Test
    @DisplayName("CP34 - Listar categorías con paginación")
